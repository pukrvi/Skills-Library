...
4. **Gather Evidence in Multi-Component Systems**
   ...
   **This reveals:** Which layer fails (for example, secrets to workflow passes, workflow to build fails)
...
1. **Create Failing Test Case**
   ...
   - Use a test-driven-development workflow or skill, if available, for writing proper failing tests
...
5. **If 3+ Fixes Failed: Question Architecture**
   ...
   **Discuss with your human collaborator before attempting more fixes**
